  ...
  return (
    <main>
      ...
      <section className="md:py-16 py-8 text-center px-2" id="preco">
        <h2 className="md:text-6xl text-2xl font-bold md:mt-16 mb-10">
          Preço Simples e Transparente
        </h2>
        <p className="text-gray-700 mt-4 text-sm md:text-xl max-w-3xl mx-auto mb-10">
          Escolha um dos planos que mais cabe no seu bolso! Sinta-se livre para escolher
